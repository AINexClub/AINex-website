...
const executeEventsScript = () => {
    ...
    function createEventCard({ title, description, date, location, imageSrc, }) {
        return `
...
`;
    ...
    function createSlideNavigation(prev, next) {
        return `
...
`;
    ...
    function createGalleryCard({ title, description, images, }) {
...
`;
    ...
    const carouselItems = [
        {
            id: "slide1",
            content: createHeroContent("Our Gallery", "Explore our collection of images showcasing our products, events, and more."),
  ...
  `,
        ...
        {
            id: "slide3",
            content: createHeroContent("Thank You", "We appreciate your interest in our gallery. Feel free to explore more!"),
            prevSlide: createSlideNavigation("❮ slide"),
        },
    ];
    // Render carousel
